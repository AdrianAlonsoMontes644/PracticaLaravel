            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('comics.index') }}">{{ __('Comics') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('animes.index') }}">{{ __('Animes') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('mangas.index') }}">{{ __('Mangas') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('empezado.index') }}">{{ __('Empezado') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('interes.index') }}">{{ __('Intereses') }}</a>
                        </li>
                    </ul>
                    @endif
